...
(let ((map outline-mode-map))
  (define-key map (kbd "M-[ d") 'outline-hide-more)
  (define-key map (kbd "M-[ c") 'outline-show-more)
  (define-key map (kbd "M-[ a") 'outline-previous-visible-heading)
  (define-key map (kbd "M-[ b") 'outline-next-visible-heading)
